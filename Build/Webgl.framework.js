...
// end include: preamble.js
  ...
  function _CacheValue(key, value) {
  ...
  var State = {websockets:{},timeoutIDs:{},onOpenCallback:null,onCloseCallback:null,onMessageCallback:null,onDataCallback:null,onErrorCallback:null};
  function _JsWs_Close(id) {
  ...
  function _JsWs_Connect(id, pUrl) {
  ...
  function _JsWs_Send_Data(id, bufferPtr, offset, count) {
  ...
  function _JsWs_Send_Message(id, pMsg) {
  ...
  function _JsWs_SetOnCloseCallback(obj) {
          State.onCloseCallback = obj;
      }

  function _JsWs_SetOnDataCallback(obj) {
          State.onDataCallback = obj;
      }

  function _JsWs_SetOnErrorCallback(obj) {
          State.onErrorCallback = obj;
      }

  function _JsWs_SetOnMessageCallback(obj) {
          State.onMessageCallback = obj;
      }

  function _JsWs_SetOnOpenCallback(obj) {
          State.onOpenCallback = obj;
      }

  function _Navigate(url, windowId = "_self") {
  ...
  function _RetrieveCachedValue(key) {
          const keyString = UTF8ToString(key);
  ...
  function _SaveAuthorizationCookie(value) {
          const valueString = UTF8ToString(value);
...
var wasmImports = {
  ...
  "JsWs_Close": _JsWs_Close,
  "JsWs_Connect": _JsWs_Connect,
  "JsWs_GetState": _JsWs_GetState,
  "JsWs_Send_Data": _JsWs_Send_Data,
  "JsWs_Send_Message": _JsWs_Send_Message,
  "JsWs_SetOnCloseCallback": _JsWs_SetOnCloseCallback,
  "JsWs_SetOnDataCallback": _JsWs_SetOnDataCallback,
  "JsWs_SetOnErrorCallback": _JsWs_SetOnErrorCallback,
  "JsWs_SetOnMessageCallback": _JsWs_SetOnMessageCallback,
  "JsWs_SetOnOpenCallback": _JsWs_SetOnOpenCallback,
  "Navigate": _Navigate,
  "RetrieveCachedValue": _RetrieveCachedValue,
  "SaveAuthorizationCookie": _SaveAuthorizationCookie,
